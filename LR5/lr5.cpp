...
public:
    ...
    void input() {
        // Введення назви деталі з перевіркою
        while (true) {
            cout << "Введіть назву деталі: ";
            getline(cin, name);
            if (!name.empty()) {
                break; // Коректний ввід
            }
            cout << "Помилка. Назва деталі не може бути порожньою. Спробуйте ще раз." << endl;
        }

        // Введення артикулу деталі з перевіркою
        while (true) {
            ...
            cout << "Помилка. Артикул деталі не може бути порожнім. Спробуйте ще раз." << endl;
        }
